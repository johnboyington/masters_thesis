...
It's basis in infomation theory means it has a grounding in mathematics that is related to neutronic behavior, an obvious advantage for the application.
...
Neutrons, often large in quantity, behave similar to gasses.
...
Since neutron spectra are often goverened by known, analytic models, unfolding can be considered a process perturbing model coefficients instead of energy bin values.
