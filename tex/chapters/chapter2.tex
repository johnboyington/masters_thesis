...
By placing a detector $k$ with associated response function $R(E)$ in a neutron spectrum $\phi(E)$, a response $N_k$ is exhibited subject to an uncertainty $\epsilon_k$ that may come from measurement noise or other sources.
